<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Index.Master" AutoEventWireup="true" CodeBehind="EntryHome.aspx.cs" Inherits="ZY.Entry.EntryHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="sum">
        <div class="top">
            <asp:Button ID="Button1" runat="server" CssClass="add" ruant="server" Text="新增入职" BorderStyle="None" OnClick="Button1_Click" />
        ...
        <div class="center">
            <asp:Button ID="Button4" CssClass="add1" runat="server" Text="待入职员工" OnClick="Button4_Click"/>
            <asp:Button ID="Button5" CssClass="add2" runat="server" Text="已入职员工" OnClick="Button5_Click" BorderColor="White"/>
        </div>
        <div class="buttom">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ShowHeader="False">
                <ItemTemplate>
                    <asp:Button ID="Button1" CssClass="cz" runat="server" CausesValidation="false" CommandArgument='<%# Eval("EntryID") %>' CommandName="" OnCommand="Button1_Command" Text="修改" />
                </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="操作" ShowHeader="False">
                <ItemTemplate>
                    <asp:Button ID="Button2" CssClass="cz" runat="server" CausesValidation="false" OnCommand="Button2_Command" CommandName="" CommandArgument='<%# Eval("EntryID") %>' OnClientClick="return confirm('确定入职该员工吗?')" Text="入职" />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="操作" ShowHeader="False">
                <ItemTemplate>
                    <asp:Button ID="Button3" CssClass="cz" runat="server" CausesValidation="false" CommandName="" OnCommand="Button3_Command" CommandArgument='<%# Eval("EntryID") %>' OnClientClick="return confirm('确定删除该员工吗?')" Text="删除" />
                </ItemTemplate>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ShowHeader="False">
                <ItemTemplate>
                    <asp:Button ID="Button1" CssClass="cz" runat="server" CausesValidation="false" OnCommand="Button1_Command1" CommandArgument='<%# Eval("EntryID") %>' CommandName="" Text="修改" />
                </ItemTemplate>
                <ControlStyle BackColor="#5BC0DE" CssClass="btn1" Font-Bold="False" ForeColor="White" Height="40px" Width="110px" BorderColor="White" BorderStyle="Solid" />
                <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" BorderStyle="None" />
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" BorderStyle="Outset" />
             ...
             <asp:TemplateField HeaderText="操作" ShowHeader="False">
                <ItemTemplate>
                    <asp:Button ID="Button2" CssClass="cz" runat="server" CausesValidation="false" OnCommand="Button2_Command1" CommandName="" CommandArgument='<%# Eval("EntryID") %>' OnClientClick="return confirm('确定取消入职该员工吗?')" Text="取消入职" />
                </ItemTemplate>
                <ControlStyle BackColor="orange" CssClass="btn1" Font-Bold="False" ForeColor="White" Height="40px" Width="110px" BorderColor="White" BorderStyle="Solid" />
            </asp:TemplateField>
        </Columns>
