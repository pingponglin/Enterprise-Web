<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Index.Master" AutoEventWireup="true" CodeBehind="StaffUpd1.aspx.cs" Inherits="ZY.Staff.StaffUpd1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label6" runat="server" CssClass="c11" Text="联系电话:"></asp:Label><asp:TextBox ID="TextBox6" CssClass="TextBox5" runat="server"></asp:TextBox>
    </p>
    <%--<p class="post">
