<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Index.Master" AutoEventWireup="true" CodeBehind="PostMain.aspx.cs" Inherits="ZY.Class.PostMain" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <tr class="shujuhang" style="height: 20px;">
                                ...
                                <td><%# Eval("PostID")%></td>
                                <td><%# Eval("PostName")%></td>
                                <td><%# Eval("PostSalary")%></td>

                                <td><%# Eval("PostRecruitsed")%></td>
                                <td><%# Eval("ClassID")%></td>
                                <td><%# Eval("PostComment")%></td>
                                <%--操作按钮--%>
                                <td><a href='EditPost.aspx?PostID=<%# Eval("PostID") %>' class="XGANYS">修改</a></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
