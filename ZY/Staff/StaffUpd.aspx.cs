...
namespace ZY.Staff
{
    public partial class StaffUpd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                TextBox1.Text = BLL.StaffBLL.SelALLStaff(staff)[0].EntryName;
                ddlSex.Text = BLL.StaffBLL.SelALLStaff(staff)[0].EntryGender;
                TextBox3.Text = BLL.StaffBLL.SelALLStaff(staff)[0].EntryAge.ToString();
                DropDownList1.Text = BLL.StaffBLL.SelALLStaff(staff)[0].EntrySchool;
                TextBox5.Text = BLL.StaffBLL.SelALLStaff(staff)[0].EntryIDcard;
                TextBox6.Text = BLL.StaffBLL.SelALLStaff(staff)[0].EntryPhone;
            }
        }
        //重置
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Response.Write("<script>alert('修改成功');location.href='StaffHome.aspx'</script>");
                    }
                    else
                    {
                        Response.Write("<script>alert('修改失败，请联系管理员');location.href='StaffHome.aspx'</script>");
                    }
                }
            }
        }
